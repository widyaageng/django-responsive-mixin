...
# added to be compatible with latest django middleware classes
...
""" process request and process response method will not be executed if custom middleware
 is not inheriting from MiddlewareMixin, only MiddlewareMixin provides __call__ what will
 process method process_request and process_response"""
